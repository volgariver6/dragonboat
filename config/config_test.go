...
func TestGossipConfigValidate(t *testing.T) {
	tests := []struct {
		...
		{"myhost.com:12345", "myhost2.net:12345", []string{"128.0.0.1:1234"}, true},
		...
		{"myhost.com:12345", ":12345", []string{"128.0.0.1:12345"}, true},
		...
		{"myhost.com:12345", "302.23.45.1:12345", []string{"128.0.0.1:12345"}, true},
